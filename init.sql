...
CREATE TABLE diu.models_arima (
    version INT NOT NULL,
    created_at TIMESTAMP DEFAULT NOW(),
    feature TEXT NOT NULL,
    cluster INT NOT NULL,
    test_data JSONB NOT NULL,
    pred_data JSONB NOT NULL,
    p INT NOT NULL,
    d INT NOT NULL,
    q INT NOT NULL
);

CREATE TABLE diu.lstm_stats (
    id SERIAL PRIMARY KEY,
    time TIMESTAMPTZ NOT NULL,
    y_pred JSONB NOT NULL,
    y_test JSONB NOT NULL,
    mae DOUBLE PRECISION NOT NULL,
    mse DOUBLE PRECISION NOT NULL,
    r2 DOUBLE PRECISION NOT NULL,
    random_indices JSONB NOT NULL,
    residuals JSONB NOT NULL,
    mae_per_feature JSONB NOT NULL
);
...
GRANT SELECT ON diu.lstm_stats TO grafanareader;
GRANT SELECT ON diu.models TO grafanareader;
GRANT SELECT ON diu.models_arima TO grafanareader;
